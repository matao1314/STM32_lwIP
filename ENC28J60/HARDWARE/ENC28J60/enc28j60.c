...
//	RCC_APB1PeriphClockCmd(	RCC_APB1Periph_SPI1,  ENABLE );//SPI1时钟使能 	
...
//	SPI_Cmd(SPI1, ENABLE); //使能SPI外设
	...
	SPI_InitTypeDef  SPI_InitStructure;	
	/* 使能 SPI1 时钟 */                         
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA | RCC_APB2Periph_GPIOE |RCC_APB2Periph_GPIOB| RCC_APB2Periph_SPI1, ENABLE);
	/* ---------enc28j60 通信I/O初始化----------------
